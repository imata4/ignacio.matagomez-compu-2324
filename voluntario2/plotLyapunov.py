...
x, y = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario2/lyapunov_E=1.txt")
x1, y1 = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario2/lyapunov_E=3.txt")
x2, y2 = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario2/lyapunov_E=5.txt")
x3, y3 = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario2/lyapunov_E=10.txt")
x4, y4 = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario2/lyapunov_E=15.txt")
...
plt.plot(x, y, color='blue', label='E=1', alpha=1)  # Dibuja los puntos de datos con transparencia
plt.plot(x1, y1, color='red', label='E=3', alpha=1)  # Dibuja los puntos de datos con transparencia
plt.plot(x2, y2, color='purple', label='E=5', alpha=1)  # Dibuja los puntos de datos con transparencia
plt.plot(x3, y3, color='orange', label='E=10', alpha=1)
plt.plot(x4, y4, color='green', label='E=15', alpha=1)
...
plt.xlabel('$t_f$ (s)')
plt.ylabel('$\lambda$ ')
plt.title('Coeficientes de Lyapunov para distintas energías y condiciones iniciales $\phi=0.1rad$ y $\psi=0.2rad$')
