...
x, y = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario1/energiacinetica.txt")
x1, y1 = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario1/energiapotencial.txt")
x2, y2 = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario1/energiatotal.txt")
...
plt.plot(x, y, color='blue', label='Energía cinética')  # Dibuja los puntos de datos si pongo scatter, si pongo plot es una línea
plt.plot(x1, y1, color='red', label='Energía potencial')  # Dibuja los puntos de datos
plt.plot(x2, y2, color='yellow', label='Energía total')  # Dibuja los puntos de datos
...
plt.xlabel('Tiempo')
plt.ylabel('Energía')
plt.title('Comparación energías')
