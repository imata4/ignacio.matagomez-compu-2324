...
x, y ,errx,erry= load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario1/datosPC.txt")
x1, y1,errx1,erry1 = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario1/datosJOEL-lm-O3.txt")
x2, y2,errx2,erry2 = load_data_from_file("C:/Users/ignac/OneDrive/Escritorio/Fisica23-24/FisicaComputacional/Git/ignacio.matagomez-compu-2324/voluntario1/datosJOEL-lm-O2.txt")
...
plt.xlabel('N (nº de partículas)')
plt.ylabel(' t (s)')
plt.title('Rendimiento de 13th Gen Intel(R) Core(TM) i7-1360P 2.20 GHz vs Joel, para distintas formas de optimización')
